package com.example.mypokedexchimali.adapters.viewholders
...
class PokemonViewHolder(private val binding: ItemPokemonBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    private fun getPokemonInfo(url:String, imageView: ImageView, context:Context){
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            val result: com.example.mypokedexchimali.model.pokemon.Pokemon? = pokemonRepository.getPokemonInfo(pokemonNumber)
